...
if(isset($_POST["submit"])&&$_POST["submit"]=="确认付款")
{
    ...
    if($BookId==""||$MemberName==""||$OrderNum==""||$OrderTime==""||$OrderState==""||$BookPrice==""||$address==""||$card==""||$password==""||$OrderID=="")
    {
    ...
    else
    {
        ...
        if($judge4<$OrderNum){
            ...
            $sql="update orders set OrderNum='$OrderNum',OrderTime='$OrderTime',OrderState='$OrderState',BookPrice='$BookPrice' where OrderID='$OrderID'";
